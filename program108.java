...
// description - write a program to accsepct a array from user and perform BinarySeach operation
...
class Display
{
 ...
 boolean BinarySearchEfficient(int no)
 {
   int istart = 0;
   int imid = 0;
   int iend = isize - 1;
...
class program108
{
  public static void main(String a[])
  {
    ...
    boolean bret = dobj.BinarySearchEfficient(val);
    if(bret == true)
    {
