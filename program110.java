...
// description - write a program to accsepct a array from user and perform BinraySerachInc ,     BinarySearchDec,BinarySearchEfficientInc,BinarySearchEfficentDec
...
//________________________________________________________________________________
 ...
 boolean BinarySearchEfficientInc(int no)
 {
   ...
   { 
     ...
     if(Arr[imid] == no||Arr[imid] == istart||Arr[imid] == iend)
     {
         bflag = true;
         break;
     }
...
boolean BinarySearchEfficientDec(int no)
 {
   int istart = 0;
   int imid = 0;
   int iend = isize - 1;
